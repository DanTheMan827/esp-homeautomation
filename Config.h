...
bool loadConfig()
{
  ...
  RELAY_REVERSE_1 = json["invRelay1"];
  RELAY_REVERSE_2 = json["invRelay2"];

  SENSOR_REVERSE_1 = json["invSense1"];
  SENSOR_REVERSE_2 = json["invSense2"];

  garageDoor1.reverseRelay(RELAY_REVERSE_1);
  garageDoor1.reverseSensor(SENSOR_REVERSE_1);

  garageDoor2.reverseRelay(RELAY_REVERSE_2);
  garageDoor2.reverseSensor(SENSOR_REVERSE_2);
